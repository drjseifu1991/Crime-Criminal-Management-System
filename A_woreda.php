...
<!--close-Header-part--> 
        ...
        <?php 
        $name = $description = $name_err = $z_id =  $message = "";
       //$description_err = "";
            if (isset($_POST['register'])){


                $name = mysqli_real_escape_string($db, $_POST['name']);
                $z_id = mysqli_real_escape_string($db, $_POST['z_id']);
                $description = mysqli_real_escape_string($db, $_POST['description']);

                if(empty($_POST['name'])){
                  $name_err = "Enter woreda name!";
                }
                   ...
                   $name_err = "Letters and white space only";
                        ...
                        $query = "INSERT INTO woreda ( zone_id, name, description) VALUES ('$z_id', '$name', '$description')";
                        mysqli_query($db, $query);

                        $message = "Woreda register successfully!";
                }
              }
        ?>
<!--top-Header-menu-->
...
<div id="sidebar"><a href="Admin.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li  class="active"><a href="A_woreda.php"><i class="icon icon-map-marker"></i> <span>Register Woreda</span></a></li>
    ...
    <div class="span6">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="A_woreda.php" method="POST" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">Zone Name :</label>
              <div class="controls">
                <option>Select zone</option>
                 <select name="z_id" id="z_id" class="span11">
                  <?php 
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="name" placeholder="Woreda name" />
                <span class="error">
                  <?php echo $name_err; ?>
                </span>
