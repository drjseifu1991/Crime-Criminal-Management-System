...
<div id="sidebar"><a href="CPP_index.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-info-sign"></i> <span>Mereja<b class="caret"></b></span></a> 
      <ul>
        <li><a href="CPP_mereja.php"><i class="icon-plus"></i>Register Mereja</a></li>
    ...
    <li class="active" class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-eye-open"></i> <span> News<b class="caret"></b></span></a>
      <ul>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="DP_index.php" ><i class="icon-home"></i> Home</a><a href="CPP_v_new.php" class="current">View New</a> </div>
  </div>
<!--End-breadcrumbs-->
