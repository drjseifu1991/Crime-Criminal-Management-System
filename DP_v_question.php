  ...
  <ul>
    ...
    <li class="active" class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-question-sign"></i> <span>Question<b class="caret"></b></span></a>
      <ul>
        ...
        <li class="active"><a href="DP_v_question.php"><i class="icon-eye-open"></i>View Question</a></li>
      </ul>
    </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="DP_index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="DP_v_question.php" class="current" >View Question</a></div>
  </div>
<!--End-breadcrumbs-->
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              ?>
                  ...
                  <td><button class="btn btn-success"><a href="DP_question.php"></a> Ansewr </button></td>
