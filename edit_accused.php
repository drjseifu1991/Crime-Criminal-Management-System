...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="DP_index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="edit_accused.php" class="current" >Edit Accused</a>
    </div>
  </div>
<!--End-breadcrumbs-->
  ...
  <hr>
   <?php 
          $fname = $mname = $lname = $gender = $age =$nationality = $region = $zone = $woreda = $kebele = $mobile = $elevel = $mstatus = $religion = $job = $crime = $description = "";
                //variable for error
          $fname_err = $mname_err = $lname_err = $gender_err = $age_err =$nationality_err = $region_err = $zone_err = $woreda_err = $kebele_err = $mobile_err = $elevel_err = $mstatus_err = $religion_err = $job_err = $crime_err = $description_err = "";

if(isset($_GET['edit'])){
  $id = $_GET['edit'];
  $update = true;
    $record = mysqli_query($db, "SELECT * FROM accused WHERE id=$id");
    ...
    if (isset($_POST['save'])){
                ...
                $crime = mysqli_real_escape_string($db, $_POST['crime']);
          ...
          if (empty ($_POST["nationality"])) {  
           ...
           if (empty ($_POST["woreda"])) {  
              //array_push($fname_err, "You didn't enter the first name.");
            $woreda_err = "You didn't enter the woreda.";    
          } 

          else if (ctype_alpha(str_replace(' ', '', $woreda)) === false) {
            $woreda_err = "Woreda must contain letters and spaces only";
          }
          else{}

           if (empty ($_POST["kebele"])) {  
              //array_push($fname_err, "You didn't enter the first name.");
            $kebele_err = "You didn't enter the kebele.";    
          } 
          ...
          $crime_err = "You didn't enter the crime type.";    
          } 

          else if (ctype_alpha(str_replace(' ', '', $elevel)) === false) {
            $crime_err = "Crime type level must contain letters and spaces only";
          }
          else{}
          ...
          if(empty($_POST['description'])){
              $description_err = "Crime case must be describe!";
                ...
                $query = "UPDATE accused SET fname= '$fname', mname = '$mname', lname = '$lname', gender = '$gender', age = '$age', job = '$job', nationality = '$nationality', region = '$region', zone = '$zone', woreda = '$woreda', kebele = '$kebele', mobile = '$mobile', elevel = '$elevel',religion = '$religion', mstatus = '$mstatus', crime = '$crime', description = '$description' WHERE id = '$id' ";
                mysqli_query($db, $query);
                echo "<h3>Editing Success!</h3> ";
          }
    ?>
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="edit_accused.php" method="POST" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="nationality" value="<?php echo $nationality; ?>" />
                <br>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="zone" value="<?php echo $zone; ?>" />
                <br>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="woreda" value="<?php echo $woreda; ?>"/>
                <br>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="kebele" value="<?php echo $kebele; ?>" />
                <br>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="elevel" value="<?php echo $elevel; ?>" />
                <br>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="religion" value="<?php echo $religion; ?>" />
                <br>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="job" value="<?php echo $job; ?>" />
                <br>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="crime" value="<?php echo $crime; ?>" />
                <br>
