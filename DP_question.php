...
<div id="sidebar"><a href="DP_index.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active" class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-question-sign"></i> <span>Question<b class="caret"></b></span></a>
      <ul>
        <li class="active"><a href="DP_question.php"><i class="icon-plus"></i>Ansewr Question</a></li>
...
if(isset($_POST['save'])){
        ...
        if(empty($_POST['question'])){
          $question_id_err = "Select questions!";
        }

        if(empty($_POST['answer'])){
          $ansewr_err = "Ansewr the question!";
        }

        else{
          $query = "INSERT INTO answer(question, answer) VALUES ('$question', '$answer')";
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="DP_index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="DP_question.php" class="current" >Ansewr Questions</a></div>
  </div>
<!--End-breadcrumbs-->
    ...
    <div class="span6">
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>Ansewr for Question</h5>
        </div>
        <div class="widget-content nopadding">
          <form action="DP_question.php" method="post" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">Question :</label>
              <div class="controls">
                <select name="question" id="question " class="span11">
                  <?php 
                ...
                <br>
                 <span class="error"><?php echo $question_id_err; ?></span>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <textarea class="span11" name="answer" placeholder="Answer"></textarea>
                <br>
                 <span class="error"><?php echo $ansewr_err; ?></span>
              </div>
            </div>
