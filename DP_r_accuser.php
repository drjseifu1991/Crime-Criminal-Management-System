...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="DP_index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="DP_r_accuser.php" class="current" >Register Accuser</a></div>
  </div>
<!--End-breadcrumbs-->
          ...
          $crime_err = "You didn't enter the crime type.";    
            ...
            $crime_err = "Crime type level must contain letters and spaces only";
              ...
              $description_err = "Crime case must be describe!";
                ...
                $query = "INSERT INTO accuser (fname, mname, lname, gender, age, mobile, nationality, region, zone, woreda, kebele, elevel, mstatus, religion, job, crime, description) VALUES ('$fname', '$mname', '$lname', '$gender', '$age', '$mobile', '$nationality', '$region', '$zone', '$woreda', '$kebele', '$elevel', '$mstatus', '$religion', '$job', '$crime', '$description')";
    ...
    <div class="span6">
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>Register Accuser</h5>
        </div>
        <div class="widget-content nopadding">
          <form action="DP_r_accuser.php" method="POST" class="form-horizontal">
