...
<div id="sidebar"><a href="DP_index.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active" class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-map-marker"></i> <span>Insurance<b class="caret"></b></span></a> 
      <ul>
        <li class="active"><a href="PH_v_i_question.php"><i class="icon-plus"></i>View Question</a></li>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            ...
            //   $query = "SELECT * FROM auth_role WHERE role_id != 5;
              $query = "SELECT question.title, question.description, question.date_time, users.fname, users.mname FROM question inner join users on question.user = users.id WHERE role='Insurance'";
