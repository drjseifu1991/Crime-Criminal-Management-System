...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    ...
    <li class="active"><a href="CPP_notification.php"><i class="icon icon-bell"></i> <span class="text">Notification</span></a>
    </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="DP_index.php" ><i class="icon-home"></i> Home</a><a href="CPP_notification.php" class="current">Notification</a> </div>
  </div>
<!--End-breadcrumbs-->
