...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="DP_index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="edit_accuser.php" class="current" >Edit Accuser</a>
    </div>
  </div>
<!--End-breadcrumbs-->
    ...
    if (isset($_POST['save'])){
          ...
          if(empty($_POST['description'])){
              $description_err = "Crime case must be describe!";
                ...
                $query = "UPDATE accuser SET fname= '$fname', mname = '$mname', lname = '$lname', gender = '$gender', age = '$age', job = '$job', nationality = '$nationality', region = '$region', zone = '$zone', woreda = '$woreda', kebele = '$kebele', mobile = '$mobile', elevel = '$elevel',religion = '$religion', mstatus = '$mstatus', crime = '$crime', description = '$description' WHERE id = '$id' ";
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="edit_accuser.php" method="POST" class="form-horizontal">
