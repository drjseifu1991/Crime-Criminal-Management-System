    ...
    $crime_err = "You didn't enter the crime type.";    
      ...
      $crime_err = "Crime type level must contain letters and spaces only";
        ...
        $description_err = "Crime case must be describe!";
          ...
          $query = "INSERT INTO accused (fname, mname, lname, gender, age, mobile, nationality, region, zone, woreda, kebele, elevel, mstatus, religion, job, crime, description) VALUES ('$fname', '$mname', '$lname', '$gender', '$age', '$mobile', '$nationality', '$region', '$zone', '$woreda', '$kebele', '$elevel', '$mstatus', '$religion', '$job', '$crime', '$description')";
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="DP_r_accused.php" method="POST" class="form-horizontal">
