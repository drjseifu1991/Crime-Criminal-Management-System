...
<div id="sidebar"><a href="CPP_index.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-question-sign"></i> <span> Question<b class="caret"></b></span></a>
      <ul>
        <li><a href="CPP_r_question.php"><i class="icon-plus"></i>Register Question</a></li>
        <li><a href="CPP_v_question.php"><i class="icon-eye-open"></i>View Question</a></li>
      </ul>
    </li>
    <li class="active" class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-comments"></i> <span> Comment<b class="caret"></b></span></a>
      <ul>
        <li><a href="CPP_r_comment.php"><i class="icon-plus"></i>Give Comment</a></li>
        <li class="active"><a href="CPP_v_comment.php"><i class="icon-eye-open"></i>View Comment</a></li>
      </ul>
    </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="DP_index.php" ><i class="icon-home"></i> Home</a><a href="CPP_v_comment.php" class="current">View Comment</a> </div>
  </div>
<!--End-breadcrumbs-->
