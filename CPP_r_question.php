...
<div id="sidebar"><a href="CPP_index.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active" class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-question-sign"></i> <span> Question<b class="caret"></b></span></a>
      <ul>
        <li class="active"><a href="CPP_r_question.php"><i class="icon-plus"></i>Register Question</a></li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="DP_index.php" ><i class="icon-home"></i> Home</a><a href="CPP_r_question.php" class="current">Question</a> </div>
  </div>
<!--End-breadcrumbs-->
...
<?php 
  ...
  if(isset($_POST['send'])){
        ...
        if(empty($_POST['question'])){
          $question_err = "Write ur questions!";
        }

        else{
          $query = "INSERT INTO question(question, session) VALUES ('$question', '$session')";
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="CPP_r_question.php" method="post" class="form-horizontal">     
            <div class="control-group">
              <label class="control-label">Question</label>
              <div class="controls">
                <textarea class="span11" name="question" placeholder="Write ur question?"></textarea>
                <br>
