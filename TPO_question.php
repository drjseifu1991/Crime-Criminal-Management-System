...
$question = $ansewr = "";
$question_err = $ansewr_err = "";


if(isset($_POST['save'])){

        $question = mysqli_real_escape_string($db, $_POST['question']);
        $ansewr = mysqli_real_escape_string($db, $_POST['ansewr']);

        if(empty($_POST['question'])){
          $question_err = "Select questions!";
        }

        if(empty($_POST['ansewr'])){
          $ansewr_err = "Ansewr the question!";
        }

        else{
          $query = "INSERT INTO ans_question(question, ansewr) VALUES ('$question', '$ansewr')";
        }
}
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="TPO_index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="TPO_question.php" class="current" >Answer Question</a></div>
  </div>
<!--End-breadcrumbs-->
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="TPO_question.php" method="post" class="form-horizontal">
