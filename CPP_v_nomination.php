...
<div id="sidebar"><a href="CPP_index.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li><a href="CPP_v_crime.php"><i class="icon icon-file"></i> <span>View Crime</span></a></li><li class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-eye-open"></i> <span> News<b class="caret"></b></span></a>
      <ul>
