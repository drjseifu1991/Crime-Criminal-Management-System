  ...
  <ul>
    ...
    <li class="active" class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-pencil"></i> <span>Post<b class="caret"></b></span></a>
      <ul>
        ...
        <li class="active"><a href="TPO_v_notice.php"><i class="icon-eye-open"></i>View Notice</a></li>
      </ul>
    </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="DP_index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="DP_v_notice.php" class="current" >View Notice</a></div>
  </div>
<!--End-breadcrumbs-->
