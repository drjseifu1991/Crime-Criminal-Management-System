...
<ul>
  <li><a href="PR_index.php"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>
    <li class="active" class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-map-marker"></i> <span>Question<b class="caret"></b></span></a> 
      <ul>
        <li class="active"><a href="PR_r_question.php"><i class="icon-plus"></i>Ask Question</a></li>
        <li><a href="PR_v_question.php"><i class="icon-eye-open"></i>View Question</a></li>
      </ul>
    </li>
    <li><a href="PR_v_report.php"><i class="icon icon-home"></i> <span>View Report</span></a> </li>
  </ul>
</div>
<!--sidebar-menu-->
...
<!--breadcrumbs-->
  ...
  <?php
    ...
    if(empty($_POST['title'])) {
        ...
        $query = "INSERT INTO question (title, description, user, role) VALUES ('$title', '$description', '$user_id', 'Presecuter')";
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="PR_r_question.php" method="post" class="form-horizontal">
