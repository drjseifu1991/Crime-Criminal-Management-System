...
<div id="sidebar"><a href="CPP_index.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active"><a href="CPP_phone.php"><i class="icon icon-phone-sign"></i> <span>Phone Number</span></a></li>
      <?php 
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="DP_index.php" ><i class="icon-home"></i> Home</a><a href="CPP_phone.php" class="current">Phone</a> </div>
  </div>
<!--End-breadcrumbs-->
