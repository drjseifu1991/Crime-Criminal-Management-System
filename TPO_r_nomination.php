...
<div id="sidebar"><a href="TPO_index.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active" class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-comments"></i> <span>Nomination<b class="caret"></b></span> </a>
      <ul>
        <li class="active"><a href="TPO_r_nomination.php"><i class="icon-plus"></i>Register Nomination</a></li>
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="TPO_r_nomination.php" enctype="multipart/form-data" method="POST" class="form-horizontal">
