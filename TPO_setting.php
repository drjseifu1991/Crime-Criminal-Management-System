...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    ...
    <li class="active" ><a title="" href="TPO_setting.php"><i class="icon icon-cog"></i> <span class="text">Settings</span></a></li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="TPO_index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="TPO_setting.php" class="current" >Setting</a></div>
  </div>
<!--End-breadcrumbs-->
