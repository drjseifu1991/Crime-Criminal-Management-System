...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    <li class="active" ><a title="" href="TPO_profile.php"><span class="profile"><?php  echo $_SESSION['uname']; ?></span></a>
    </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="TPO_index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="TPO_profile.php" class="current" >Profile</a></div>
  </div>
<!--End-breadcrumbs-->
