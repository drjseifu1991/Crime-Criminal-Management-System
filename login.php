...
$uname = $uname_err = $password = $password_err = $hash_password = "";
if(isset($_POST['login'])){
    ...
    $query = "SELECT * FROM users where uname='$uname' AND password='$hash_password' LIMIT 0,1";
    ...
    if(mysqli_num_rows($result) == 1){
        ...
        // check if role is 9
        $query = "SELECT * FROM auth_role where user_id='$id' AND role_id=9";
        $result = mysqli_query($db, $query);
        if(mysqli_num_rows($result) > 0){
            $_SESSION['uname'] = $uname;
            $_SESSION['role_id'] = 9;
        ...
        // check if role is 10
        $query = "SELECT * FROM auth_role where user_id='$id' AND role_id=10";
        $result = mysqli_query($db, $query);
        if(mysqli_num_rows($result) > 0){
            $_SESSION['uname'] = $uname;
            $_SESSION['role_id'] = 10;
