...
<div id="sidebar"><a href="DP_index.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active"><a href="DP_phone.php"><i class="icon icon-phone-sign"></i> <span>Phone Number</span></a></li>
      <?php 
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="DP_index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="DP_phone.php" class="current" >View Phone Number</a></div>
  </div>
<!--End-breadcrumbs-->
