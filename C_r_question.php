...
<div id="sidebar"><a href="C_index.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active" class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-question-sign"></i> <span> Question<b class="caret"></b></span></a>
      <ul>
        <li class="active"><a href="C_r_question.php"><i class="icon-plus"></i>Register Question</a></li>
        <li><a href="C_v_question.php"><i class="icon-eye-open"></i>View Question</a></li>
      </ul>
    </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="C_index.php"><i class="icon-home"></i> Home</a><a href="C_r_question" class="current">Register Question</a> </div>
  </div>
<!--End-breadcrumbs-->
        ...
        <div class="widget-content nopadding">
          <form action="" method="post" class="form-horizontal">                        
            <div class="control-group">
              ...
              <div class="controls">
                <textarea class="span11" name="question" placeholder="Question?"></textarea>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Receiver :</label>
              <div class="controls">
                <input type="text" class="span11" name="receiver" placeholder="Receiver ID" />
