...
<ul>
    ...
    <li class="active"><a href="TP_g_report.php"><i class="icon icon-eye-open"></i>Generate Accident Report</a></li>
      <?php 
  ...
  <?php 
    ...
    if(isset($_POST['save'])){
      ...
      if(empty($_POST['case'])){
        ...
        $user_id=$_SESSION['user_id'];
        $query = "INSERT INTO report (r_case, r_desc, r_date_time, r_type, r_level, file_r, user_id) VALUES ('$case', '$description', '$date_time', 'accident', 'low', '$file', '$user_id')";
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="TP_g_report.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
