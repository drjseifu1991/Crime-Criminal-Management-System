  ...
  <ul>
    ...
    <li class="active" class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-info-sign"></i> <span>Mereja<b class="caret"></b></span></a> 
      <ul>
        ...
        <li class="active"><a href="CPP_v_mereja.php"><i class="icon-eye-open"></i>View Mereja</a></li>
      </ul>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="DP_index.php" ><i class="icon-home"></i> Home</a><a href="CPP_v_mereja.php" class="current">View Mereja</a> </div>
  </div>
<!--End-breadcrumbs-->
