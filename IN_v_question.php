  ...
  <li><a href="IN_index.php"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>
    <li class="active" class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-map-marker"></i> <span>Question<b class="caret"></b></span></a> 
      <ul>
        ...
        <li class="active"><a href="IN_v_question.php"><i class="icon-eye-open"></i>View Question</a></li>
      </ul>
    </li>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            ...
            //   $query = "SELECT * FROM auth_role WHERE role_id != 5;
              $query = "SELECT question.title, question.description, question.date_time FROM question WHERE user=$user_id AND role='Insurance'";
