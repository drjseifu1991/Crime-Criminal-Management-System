  ...
  <ul>
    ...
    <li class="active" class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-refresh"></i> <span>Punishment<b class="caret"></b></span></a> 
      <ul>
        ...
        <li class="active"><a href="TPO_v_punishment.php"><i class="icon-eye-open"></i>View Punishment</a></li>
      </ul>
    </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="TPO_index.php" ><i class="icon-home"></i> Home</a><a href="TPO_v_punishment.php" class="active">View Punishiment</a></div>
  </div>
<!--End-breadcrumbs-->
