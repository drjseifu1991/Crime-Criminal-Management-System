...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    ...
    <li class="active"><a title="" href="CPP_setting.php"><i class="icon icon-cog"></i> <span class="text">Settings</span></a></li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="DP_index.php" ><i class="icon-home"></i> Home</a><a href="CPP_setting.php" class="current">Setting</a> </div>
  </div>
<!--End-breadcrumbs-->
