...
<!--close-Header-part--> 
        ...
        <?php 
        $name = $description = $name_err = $w_id =  $message = "";
       //$description_err = "";
            if (isset($_POST['register'])){


                $name = mysqli_real_escape_string($db, $_POST['name']);
                $w_id = mysqli_real_escape_string($db, $_POST['w_id']);
                $description = mysqli_real_escape_string($db, $_POST['description']);

                if(empty($_POST['name'])){
                  $name_err = "Enter kebele name!";
                }
                   ...
                   $name_err = "Letters and white space only";
                        ...
                        $query = "INSERT INTO kebele (name, w_id, description) VALUES ('$name', '$w_id', '$description')";
                        mysqli_query($db, $query);

                        $message = "Kebele register successfully!";
                }
              }
        ?>
<!--top-Header-menu-->
...
<div id="sidebar"><a href="Admin.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li><a href="A_region.php"><i class="icon icon-edit"></i> <span>Register Region</span></a> </li>
     <li><a href="A_zone.php"><i class="icon icon-home"></i> <span>Register Zone</span></a> </li>
    <li><a href="A_woreda.php"><i class="icon icon-map-marker"></i> <span>Register Woreda</span></a></li>
    <li  class="active"><a href="A_kebele.php"><i class="icon icon-edit"></i> <span>Register Kebele</span></a> </li>
  </ul>
</div>
<!--sidebar-menu-->
    ...
    <div class="span6">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="A_kebele.php" method="POST" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">Woreda Name :</label>
              <div class="controls">
                <option>Select woreda</option>
                <select name="w_id" id="w_id" class="span11">
                  <?php 
            ...
            <div class="control-group">
              <label class="control-label">Kebele Name :</label>
              <div class="controls">
                <input type="text" class="span11" name="name" placeholder="Kebele name" />
                <span class="error">
                  <?php echo $name_err; ?>
                </span>
