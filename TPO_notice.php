...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    ...
    <li class=""><a href="TPO_notification.php"><i class="icon icon-bell"></i> <span class="text">Notification</span></a>
    </li>
...
<div id="sidebar"><a href="TPO_index.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active" class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-pencil"></i> <span>Post<b class="caret"></b></span></a>
      <ul>
        <li class="active"><a href="TPO_notice.php"><i class="icon-plus"></i>Post Notice</a></li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="DP_index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="DP_notice.php" class="current" >Post Notice</a></div>
  </div>
<!--End-breadcrumbs-->
<div class="container-fluid">
  <?php
   
  $notice = $title = $title_err = $notice_err = "";
  if (isset($_POST['save'])){
    ...
    else if(empty($_POST['notice'])){
      $notice_err = "Please Enter Notice!";
    }
    else{
      $query = "INSERT INTO notice (notice, description) VALUES ('$title', '$notice')";
      if(mysqli_query($db, $query)) {
        echo "      Notice added successfully";
      }
      else {
        echo "      Notice doesn't added successfully";
      }
    }
  }
  ?>  
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="TPO_notice.php" method="POST" class="form-horizontal">
          <div class="control-group">
              <label class="control-label">Title :</label>
              <div class="controls">
                <input type="text"  class="span11" name="title" placeholder="Title"  />
                <br>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <textarea class="span11" name="notice" placeholder="notice"></textarea>
                <br>
                 <span class="error"><?php echo $notice_err; ?></span>
              </div>
            </div>
