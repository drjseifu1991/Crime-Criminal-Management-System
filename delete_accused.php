  ...
  <ul>
    ...
    <li   class="active" class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-user-md"></i> <span>Accused<b class="caret"></b></span> </a>
      <ul>
        ...
        <li class="active"><a href="DP_v_accused.php"><i class="icon-eye-open"></i>View Accused</a></li>
      </ul>
    </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="DP_index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="delete_accused.php" class="current" >Delete Accused</a>
    </div>
  </div>
<!--End-breadcrumbs-->
          ...
          if(isset($_GET['delete'])){
            ...
            $update = true;
              ...
              if (isset($_POST['delete'])){
                ...
                $q1 = "SELECT id FROM crime WHERE accused = '$id'";
                $q2 = "DELETE FROM crime WHERE accused = '$id'";
                $query = "DELETE FROM accused WHERE id = '$id' ";
  ...
  <div class="row-fluid">
    <div class="span6">
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-question"></i> </span>
          <h5>Delete Accused???</h5>
        </div>
        <div class="widget-content nopadding">
          <form action="delete_accused.php" method="POST" class="form-horizontal">
