...
<!--close-Header-part--> 
        ...
        <?php 
        $name = $description = $name_err = $r_id = $message = "";
       //$description_err = "";
            if (isset($_POST['register'])){


                $name = mysqli_real_escape_string($db, $_POST['name']);
                $r_id = mysqli_real_escape_string($db, $_POST['r_id']);
                $description = mysqli_real_escape_string($db, $_POST['description']);

                if(empty($_POST['name'])){
                  $name_err = "Enter zone name!";
                }
                   ...
                   $name_err = "Letters and white space only";
                        ...
                        $query = "INSERT INTO zone (region_id, name, description) VALUES ( '$r_id', '$name', '$description')";
                        mysqli_query($db, $query);

                        $message = "Zone register successfully!";
                }
              }
        ?>
<!--top-Header-menu-->
...
<div id="sidebar"><a href="Admin.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li><a href="A_region.php"><i class="icon icon-edit"></i> <span>Register Region</span></a> </li>
     <li  class="active"><a href="A_zone.php"><i class="icon icon-home"></i> <span>Register Zone</span></a> </li>
    ...
    <div class="span6">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="A_zone.php" method="POST" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">Region Name :</label>
              <div class="controls">
                <option>Select region</option>
                <select name="r_id" id="r_id" class="span11">
                  <?php 
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="name" placeholder="Zone name" />
                <span class="error">
                  <?php echo $name_err; ?>
                </span>
