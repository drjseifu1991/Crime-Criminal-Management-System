...
<div id="sidebar"><a href="TPO_index.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-pencil"></i> <span>Post<b class="caret"></b></span></a>
      <ul>
        <li><a href="TPO_v_new.php"><i class="icon-eye-open"></i>View News</a></li>
    ...
    <li><a href="TPO_profile.php"><i class="icon icon-user"></i> <span>Profile</span></a></li>
    <li><a href="TPO_phone.php"><i class="icon icon-phone-sign"></i> <span>Phone Number</span></a></li> 
    <li  class="active"><a href="TPO_about.php"><i class="icon icon-info-sign"></i> <span>About</span></a></li>
    <li class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-signin"></i> <span>Go</span><b class="caret"></b></span></a>
      <?php 
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="TPO_index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="TPO_about.php" class="current" >About</a></div>
  </div>
<!--End-breadcrumbs-->
