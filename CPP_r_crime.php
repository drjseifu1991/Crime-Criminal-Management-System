...
<div id="sidebar"><a href="CPP_index.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active"><a href="CPP_v_crime.php"><i class="icon icon-file"></i> <span>View Crime</span></a></li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="DP_index.php" ><i class="icon-home"></i> Home</a><a href="CPP_r_crime.php" class="current">Crime</a> </div>
  </div>
<!--End-breadcrumbs-->
