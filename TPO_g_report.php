...
<li><a href="TPO_index.php"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>
    ...
    <li class= "active" class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-user-md"></i> <span>Report<b class="caret"></b></span></a>
      <ul>
      <li class="active"><a href="TPO_g_report.php"><i class="icon-plus"></i>Generate Report</a></li>
  ...
  <?php 
    ...
    if(isset($_POST['save'])){
      ...
      if(empty($_POST['case'])){
        ...
        $user_id=$_SESSION['user_id'];
        $query = "INSERT INTO report (r_case, r_desc, r_date_time, r_type, r_level, file_r, user_id) VALUES ('$case', '$description', '$date_time', 'accident', 'high', '$file', '$user_id')";
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="TPO_g_report.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
