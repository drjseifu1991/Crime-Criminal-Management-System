...
<div id="sidebar"><a href="Admin.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li  class="active"><a href="A_r_assign.php"><i class="icon icon-map-marker"></i> <span>Assign Role</span></a></li>
    ...
    <div class="span6">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="A_r_assign.php" method="POST" class="form-horizontal">
