...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    <li  class="active" ><a title="" href="C_profile.php"><span class="profile"><?php  echo $_SESSION['uname']; ?></span></a>
    </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="C_index.php" ><i class="icon-home"></i> Home</a><a href="C_profile" class="current">Profile</a> </div>
  </div>
<!--End-breadcrumbs-->
