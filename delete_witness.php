...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="DP_index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="delete_witness.php" class="current" >Delete Witness</a>
    </div>
  </div>
<!--End-breadcrumbs-->
          ...
          if(isset($_GET['delete'])){
            ...
            $update = true;
              ...
              if (isset($_POST['delete'])){
                ...
                $q1 = "SELECT id FROM crime WHERE witness1 = '$id'";
                $q2 = "DELETE FROM crime WHERE witness1 = '$id'";
    ...
    <div class="span6">
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-question-sign"></i> </span>
          <h5>Delete Witness???</h5>
        </div>
        <div class="widget-content nopadding">
          <form action="delete_witness.php" method="POST" class="form-horizontal">
