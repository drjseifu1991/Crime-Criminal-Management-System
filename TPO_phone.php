...
<div id="sidebar"><a href="TPO_index.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active"><a href="TPO_phone.php"><i class="icon icon-phone-sign"></i> <span>Phone Number</span></a></li> 
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="TPO_index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="TPO_phone.php" class="current" >Phone Number</a></div>
  </div>
<!--End-breadcrumbs-->
