...
<div id="sidebar"><a href="C_index.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-question-sign"></i> <span> Question<b class="caret"></b></span></a>
      <ul>
        <li><a href="C_r_question.php"><i class="icon-plus"></i>Register Question</a></li>
    ...
    <li class="active" class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-comments"></i> <span> Comment<b class="caret"></b></span></a>
      <ul>
        <li><a href="C_r_comment.php"><i class="icon-plus"></i>Give Comment</a></li>
        <li class="active"><a href="C_v_comment.php"><i class="icon-eye-open"></i>View Comment</a></li>
      </ul>
    </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="C_index.php"><i class="icon-home"></i> Home</a><a href="C_v_comment" class="current"> View Comment</a> </div>
  </div>
<!--End-breadcrumbs-->
