...
<div id="sidebar"><a href="Admin.php" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  ...
  <li><a href="IN_index.php"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>
    ...
    <li class="active"><a href="IN_v_report.php"><i class="icon icon-home"></i> <span>View Report</span></a> </li>
  </ul>
</div>
<!--sidebar-menu-->
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            ...
            //   $query = "SELECT * FROM auth_role WHERE role_id != 5;
              $query = "SELECT insurance_report.vehicle_owner, insurance_report.vehicle_type, insurance_report.vehicle_board_no, insurance_report.description, insurance_report.file, users.fname, users.mname FROM insurance_report inner join users on insurance_report.user = users.id";
