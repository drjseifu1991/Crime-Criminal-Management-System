  ...
  <ul>
    ...
    <li   class="active" class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="icon icon-map-marker"></i> <span>Assign<b class="caret"></b></span></a> 
      <ul>
        ...
        <li class="active"><a href="TPO_v_placement.php"><i class="icon-eye-open"></i>View Placement</a></li>
      </ul>
    </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="TPO_index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="TPO_v_placement.php" class="current" >View Placement</a></div>
  </div>
<!--End-breadcrumbs-->
